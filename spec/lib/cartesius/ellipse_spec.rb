...
describe Cartesius::Ellipse do
  ...
  describe '.by_definition' do
    ...
    it 'should create a simple ellipse with focus on x axis' do
      # x^2/25 + y^2/9 = 1
      ellipse = described_class.by_definition(focus1: Cartesius::Point.new(x: 4, y: 0), focus2: Cartesius::Point.new(x: -4, y: 0), distance: 10)
    ...
    it 'should create a simple ellipse with focus on y axis' do
      # x^2/9 + y^2/25 = 1
      ellipse = described_class.by_definition(focus1: Cartesius::Point.new(x: 0, y: 4), focus2: Cartesius::Point.new(x: 0, y: -4), distance: 10)
    ...
    it 'should create a general ellipse with focus on x axis' do
      # (x - 1)^2/25 + (y - 1)^2/9 = 1
      ellipse = described_class.by_definition(focus1: Cartesius::Point.new(x: 5, y: 1), focus2: Cartesius::Point.new(x: -3, y: 1), distance: 10)
    ...
    it 'should create a general ellipse with focus on y axis' do
      # (x - 1)^2/9 + (y - 1)^2/25 = 1
      ellipse = described_class.by_definition(focus1: Cartesius::Point.new(x: 1, y: 5), focus2: Cartesius::Point.new(x: 1, y: -3), distance: 10)
