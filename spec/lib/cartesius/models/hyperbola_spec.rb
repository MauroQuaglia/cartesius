...
describe Cartesius::Hyperbola do
  ...
  describe '.by_canonical' do
    ...
    it 'should create a general hyperbola with focus on x axis' do
      # (x - 1)^2/16 - (y - 1)^2/9 = 1
      hyperbola = described_class.by_canonical(center: Cartesius::Point.create(x: 1, y: 1), transverse_axis: 4, not_transverse_axis: 3, position: 1)
    ...
    it 'should create a general hyperbola with focus on y axis' do
      # (x - 1)^2/16 - (y - 1)^2/9 = -1
      hyperbola = described_class.by_canonical(center: Cartesius::Point.create(x: 1, y: 1), transverse_axis: 3, not_transverse_axis: 4, position: -1)
  ...
  describe '.by_points' do
    ...
    it 'should fail when points are not different' do
      expect {
        described_class.by_points(
            center: Cartesius::Point.origin, vertex: Cartesius::Point.origin, point: Cartesius::Point.create(x: 2, y: 1))
    ...
    it 'should fail when points are not sufficient for center in origin' do
      expect {
        described_class.by_points(
            center: Cartesius::Point.origin, vertex: Cartesius::Point.create(x: -5, y: 0), point: Cartesius::Point.create(x: 5, y: 0))
    ...
    it 'should fail when vertex and center are not aligned' do
      expect {
        described_class.by_points(
            center: Cartesius::Point.origin, vertex: Cartesius::Point.create(x: 1, y: 1), point: Cartesius::Point.create(x: 5, y: 0))
    ...
    it 'should create a simple hyperbola with focus on x axis' do
      # x^2/16 - y^2/9 = 1
      hyperbola =
          described_class.by_points(center: Cartesius::Point.origin, vertex: Cartesius::Point.create(x: 4, y: 0), point: Cartesius::Point.create(x: 0, y: 3))
    ...
    it 'should create a simple hyperbola with focus on y axis' do
      # x^2/16 - y^2/9 = -1
      hyperbola =
          described_class.by_points(center: Cartesius::Point.origin, vertex: Cartesius::Point.create(x: 0, y: 3), point: Cartesius::Point.create(x: 4, y: 0))
    ...
    it 'should create a general hyperbola with focus on x axis' do
      # (x - 1)^2/16 - (y - 1)^2/9 = 1
      hyperbola =
          described_class.by_points(center: Cartesius::Point.create(x:1, y:1), vertex: Cartesius::Point.create(x: 5, y: 1), point: Cartesius::Point.create(x: 1, y: 4))
    ...
    it 'should create a general hyperbola with focus on y axis' do
      # (x - 1)^2/16 - (y - 1)^2/9 = -1
      hyperbola =
          described_class.by_points(center: Cartesius::Point.create(x:1, y:1), vertex: Cartesius::Point.create(x: 1, y: 4), point: Cartesius::Point.create(x: 5, y: 1))
    ...
    it 'should create a simple equilateral hyperbola with focus on x axis' do
      # x^2 - y^2 = 1
      hyperbola =
          described_class.by_points(center: Cartesius::Point.origin, vertex: Cartesius::Point.create(x: 1, y: 0), point: Cartesius::Point.create(x: 0, y: 1))
    ...
    it 'should create a simple equilateral hyperbola with focus on y axis' do
      # x^2 - y^2 = -1
      hyperbola =
          described_class.by_points(center: Cartesius::Point.origin, vertex: Cartesius::Point.create(x: 0, y: 1), point: Cartesius::Point.create(x: 1, y: 0))
